...
目的决定着以下的一切：模式的结构，它的内容，它的呈现方式。了解模式的目的（了解它被设计为鼓励或者禁止的行为）可以帮助我们设计和构建更强健的模块。它能帮助我们知道在变为完全不同的模式之前可以有多少种呈现方式。它可以通过为整个团队提供一个共同的参考点，并将他们与原始的设计意图结合起来，从而减少重复。明确目的还可以更容易地测试模块，看看它们实际效果如何。

如果功能模式是界面中的对象，那么感知模式就像样式——它们一起描述了它们是什么类型的对象以及它们的感受。让我们仔细来看看它们。


[^1]: 如果我们必须区分两者，我会以更通用的方式看待功能模式，就像是柏拉图式的理想，模块作为功能模式体现，在不同的界面中有不同的呈现。
[^2]: http://smashed.by/mappingxp
[^3]: "Job to be done" (JTBD) 是一个练习，可以帮助你专注于使用产品或者服务背后的潜在动机。例如，尽管客户说他们想要买一个割草机来“割草”，但他们的更高目的可能是“始终保持草坪的低矮和美观”，这可能意味着割草机不是一个最优的选择。
[^4]: http://smashed.by/uiinventory
[^5]: 在第七和第八章节我们将会深入研究界面清单的过程，从系统目的开始，再到最小的模式，如同图标和颜色。
[^6]: 在第八章我们将会讨论更多什么时候同意模式，什么时候分离他们，什么时候新建变种等细节。
